...
private _thirstQuenched = GVAR(thirstRestored) * getNumber (_config >> QGVAR(thirstQuenched));
private _hungerSatiated = GVAR(hungerRestored) * getNumber (_config >> QGVAR(hungerSatiated));
