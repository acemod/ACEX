...
class GVAR(RscSetData): RscDisplayAttributes {
    onLoad = QUOTE([ARR_3('onLoad', _this, QQGVAR(RscSetData))] call ACEFUNC(zeus,zeusAttributes));
    onUnload = QUOTE([ARR_3('onUnload', _this, QQGVAR(RscSetData))] call ACEFUNC(zeus,zeusAttributes));
    class Controls: Controls {
        class Background: Background {};
        class Title: Title {};
